...
. In GitLab, go to your repository's menu:Settings[Webhooks]
. Add a new webhook:
  * *URL*: `http://<event_listener_route>`
  * *Trigger*: Push events
  * *SSL verification*: Disable (for lab environments)
. Click btn:[Add webhook]
. Click btn:[Test] and select *Push events* to send a test payload
