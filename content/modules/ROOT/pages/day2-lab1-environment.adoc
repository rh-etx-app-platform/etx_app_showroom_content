...
* **Dedicated ETX GitOps admin plane** (`etx-gitops` namespace)
  - Pre-deployed Argo CD instance for application team use
  - Repository: `etx-gitops` - Contains infrastructure and application manifests
  - You can deploy applications here or create your own Argo CD instance

IMPORTANT: In Lab 1 Step 5, you have the option to deploy your **own** Argo CD instance in your namespace or use the pre-deployed `etx-gitops` instance for application deployments.
...
Lab 1 Step 2: Deploy and configure Dev Spaces
      ↓
Lab 1 Step 3: Deploy supporting services (AMQ Streams, Tekton, OpenTelemetry)
      ↓
...
Once logged into GitLab, move to the existing workshop directory from the previous lab:
...
Or clone the ETX App Base application if it doesn't exist:
