...
+
NOTE: Run this from your **Dev Spaces workspace terminal** where you have the `etx_app_base_app` repository. If you configured SSH authentication in xref:day2-lab1-devspaces.adoc#_configure_git_credentials_for_push_operations[Dev Spaces Workspace], the push will work without prompts.
+
[source,bash]
----
