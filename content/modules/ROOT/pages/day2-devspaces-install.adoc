...
NOTE: The `openshift-devspaces` namespace is created for the `CheCluster` instance and Dev Spaces server components. The Dev Spaces operator itself was installed in `openshift-operators`.
