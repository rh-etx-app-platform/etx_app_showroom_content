...
[NOTE]
====
If you see `ErrImagePull` or `ImagePullBackOff` errors on pods, check:

[source,bash]
----
oc describe pod -n openshift-devspaces <pod-name>
----
...
- Incorrect image reference in the deployment
====
