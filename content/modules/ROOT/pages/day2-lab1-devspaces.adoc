...
Open a terminal from the main menu (hamburger icon in the top-left corner: menu:Terminal[New Terminal]) and create the devfile.
...
. Click btn:[Create Workspace]
. Select *Import from Git*
. Paste the repository URL with the branch reference:
+
[source,text,subs="attributes+"]
----
{gitlab_url}/software-factory/etx_app_base_app.git#feature/add-devfile
----
. Click btn:[Create & Open]
