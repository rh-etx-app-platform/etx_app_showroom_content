...
# Trigger credential prompt with a git operation
git pull
----
...
* **Password**: _paste your Personal Access Token_

The credentials are now cached in `~/.git-credentials` for future git operations.
...
Expected output: `Branch 'feature/add-devfile' set up to track remote branch...`

If the push succeeds, your Git credentials are configured correctly and you can proceed with the workshop.
