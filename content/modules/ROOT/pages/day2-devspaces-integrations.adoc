...
The devfile's `postStart` command can use these to configure the Continue extension automatically (see xref:day2-devspaces-devfiles.adoc[Devfiles]).  This will be apparent in the next steps of the lab where we create a devfile.
