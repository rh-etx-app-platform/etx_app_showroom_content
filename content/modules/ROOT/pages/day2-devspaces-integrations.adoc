...
Export your GitLab application ID and secret:
...
export GITLAB_APPLICATION_ID="REPLACE_APPLICATION_ID"
export GITLAB_APPLICATION_SECRET="REPLACE_APPLICATION_SECRET"
----

Create the secret:

WARNING: Remove the character ' around the EOF keyword. They were added just for 
rendering purposes of this documentation. Otherwise, the variables will not be substituted.
...
[source,bash,role=execute,subs="attributes"]
----
export LLM_API_KEY="REPLACE_API_KEY"
----
