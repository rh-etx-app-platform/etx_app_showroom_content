...
Set the registry URL and token first. Use the token generated by your private npm registry.

[source,bash]
----
NPM_REGISTRY_HOST="npm.registry.example.com"
NPM_TOKEN="REPLACE_NPM_TOKEN"
...
NOTE: Skip this example if the workshop application does not require a private npm registry.
