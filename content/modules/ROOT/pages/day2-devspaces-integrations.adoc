...
---
export GITLAB_APPLICATION_ID="ADD YOUR ID HERE"
export GITLAB_APPLICATION_SECRET="ADD YOUR SECRET HERE"
---
...
First, obtain an API key from the https://maas-rhdp-frontend.apps.maas.redhatworkshops.io/login[Red Hat Demo Platform MaaS^].
...
WARNING: Replace or set `LLM_API_KEY` with your actual API key from the MaaS platform before running the command.
